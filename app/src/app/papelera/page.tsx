      ...
      <div className="max-w-4xl mx-auto">
        ...
        {deletedRecordings.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-xs text-gray-600 mt-1">Las grabaciones eliminadas aparecerán aquí</p>
          </div>
        ) : (
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3 text-xs text-gray-500">
                        <span>Eliminado: {formatDate(recording.deletedAt)}</span>
                        {!isUrgent && (
        ...
        {showHardDeleteModal && recordingToHardDelete && (
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50" onClick={() => setShowHardDeleteModal(false)}>
            <div className="bg-gray-900 border border-red-500/50 rounded-xl p-6 max-w-md w-full mx-4" onClick={(e) => e.stopPropagation()}>
              <h3 className="text-xl font-bold text-red-400 mb-4">⚠️ Eliminación Permanente</h3>
